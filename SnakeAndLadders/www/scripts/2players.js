...
//player2
document.getElementById("q1").src = "images/Avtarq.gif";
...
function turnover1() {
    ...
    document.getElementById("player2turn").innerHTML = "Player2's turn";
...
function player2_roll() {
    ...
    if ((onbox2 == 95 && ranNum == 6) || (onbox2 == 96 && ranNum > 4) || (onbox2 == 97 && ranNum > 3) || (onbox2 == 98 && ranNum > 2) || (onbox2 == 99 && ranNum > 1) || (onbox2 == 100 && random >= 1)) {
        ...
        move(ranNum, onbox2,'q');
    turnover2();
}

function turnover2() {

    document.getElementById("player2Button").disabled = true;//disabling button for player1
...
function animateCongrats(x) {
    ...
    if (x == 'q')
        alert("congrats player2 reached 100")
    location.reload();
}
